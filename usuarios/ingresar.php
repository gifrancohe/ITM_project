...
<div class="container">
	...
	<button type="submit" class="btn btn-default btn-block" id="btIngresar" name="btIngresar">
...
?>
		 ...
		 <center><p>
		 <h2> <?php echo "Bienvenido ".$row['PrimerNombre']." " .$row['PrimerApellido'] ; ?></h2>
		 </p> </center>

	  	<center><a href="?menu=Administrador">
